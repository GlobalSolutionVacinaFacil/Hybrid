...
type Props = StackScreenProps<UnauthorizedStack, "ThirdStep">;

export const ThirdStep = ({ navigation }: Props): JSX.Element => {
  return (
    <View style={styles().container}>
      <Image
        style={styles().image}
        source={require("../../assets/onboarding/done.png")}
      />
      <Text style={styles().textOne}>Primeiros passos</Text>
      <Text style={styles().textTwo}>Cadastro realizado</Text>
      <Text style={styles().textThree}>
        Cadastre seus dependentes e acabe com suas preocupações
      </Text>
      <View style={styles().stepsView}>
        ...
        <Pressable style={styles().pressable} onPress={() => {}}>
          <Text style={styles().pressableText}>Começar</Text>
        </Pressable>
      </View>
    </View>
  );
